...
Command: npx gltfjsx@6.5.3 src\assets\models\free_1972.glb -t 
...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('src/assets/models/free_1972.glb') as GLTFResult
  return (
