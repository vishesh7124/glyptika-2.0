      ...
      items: [
        {
          ...
          url: "#",
          description: "Master timeline and keyframe techniques",
        },
        {
          name: "Character Rigging",
          url: "#",
          description: "Build armatures for character animation",
        },
        {
          name: "Physics Simulation",
          url: "#",
          description: "Cloth, fluid, and particle systems",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          url: "#",
          description: "Photorealistic rendering techniques",
        },
        {
          name: "Lighting Setup",
          url: "#",
          description: "Professional lighting workflows",
        },
        {
          name: "Post-Processing",
          url: "#",
          description: "Compositing and final touches",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Animation Rigs",
          url: "#",
          description: "Ready-to-use character rigs",
        },
        {
        ...
        },
        {
          ...
          url: "#",
          description: "Optimized render settings",
        },
      ],
    },
  ];
