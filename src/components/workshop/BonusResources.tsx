      ...
      items: [
        {
          ...
          url: "#",
          description: "Industry-secret techniques and shortcuts",
        },
        {
          name: "Master Classes",
          url: "#",
          description: "Extended tutorials from experts",
        },
        {
          name: "Behind the Scenes",
          url: "#",
          description: "Real studio production insights",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "HDR Environment Pack",
          url: "#",
          description: "Professional lighting environments",
        },
        {
          name: "Material Library Pro",
          url: "#",
          description: "High-end PBR materials collection",
        },
        {
          name: "Model Repository",
          url: "#",
          description: "Exclusive 3D model assets",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          url: "#",
          description: "Exclusive community and mentorship",
        },
        {
          name: "Monthly Q&A Sessions",
          url: "#",
          description: "Live sessions with industry pros",
        },
        {
          name: "Job Board Access",
          url: "#",
          description: "Exclusive industry opportunities",
        },
      ],
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#181c2b] via-[#232a3d] to-[#1e2340] flex flex-col items-center px-2 md:px-6 lg:px-8">
      ...
      <div className="w-full max-w-6xl mx-auto pb-16 md:pb-24">
        ...
        <div className="flex justify-center mt-10 md:mt-16 ">
          <Button
            className="bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-500 hover:opacity-90 text-white font-bold px-8 md:px-12 py-4 md:py-5 rounded-xl md:rounded-2xl text-lg md:text-xl shadow-xl flex items-center justify-center gap-2 md:gap-3"
            disabled
          >
