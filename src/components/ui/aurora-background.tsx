...
export const AuroraBackground = () => {
    ...
    return React.createElement('mesh',
        ...
        React.createElement('planeGeometry',{args:[512,512]}), 
...
gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            uniforms: {u_colors: {value: [new THREE.Vector4(0.00392156862745098,0.3176470588235294,0.2980392156862745,1),new THREE.Vector4(0.3333333333333333,0,1,0.57)]},u_intensity: {value: 0.072},u_rays: {value: 0.192},u_reach: {value: 0.537},u_time: {value: 0},u_mouse: {value: [0,0]},u_resolution: {value: [512,512]}},
            wireframe: false, 
...
createRoot(embedRoot).render(React.createElement(Canvas,{
        gl: {
    ...
    React.createElement(AuroraBackground)                           
));