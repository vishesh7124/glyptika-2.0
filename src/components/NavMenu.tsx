    ...
    return(
        <HoverCard >
            ...
            <HoverCardContent className="bg-gradient-to-t from-[#04050c] from-0% via-[#040b13] via-80% to-[#24246bae] to-100% w-4xl border-0 flex justify-center items-center rounded-md gap-3.5 " >
                    ...
                    <div className="animations hover:bg-[#5EC2B5] hover:cursor-pointer w-1/2 h-full flex justify-between items-center rounded-md gap-3 bg-[#000000b3] ">
                    ...
                    <div className="models hover:bg-[#5EC2B5] hover:cursor-pointer rounded-l-md w-1/2 h-full flex justify-between items-center rounded-md gap-3 bg-[#000000b3] ">
